        ...
        <Route path="*" element={
          <main className="main-content page-wrapper" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', textAlign: 'center' }}>
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '2.5rem', fontStyle: 'italic', marginBottom: '0.5rem' }}>Lost in the Garden</h2>
              <p style={{ color: 'var(--ink-muted)', marginBottom: '2rem', fontStyle: 'italic' }}>This path doesn't exist on our map.</p>
