...
export default function WorldMap({ onCountryClick }) {
  ...
  return (
    <div className="map-container" style={{ height: '500px', position: 'relative' }}>
              ...
              geographies.map(geo => {
                ...
                return (
                  <Geography
                    ...
                    style={{
                      default: {
                        fill: isHovered ? '#c17b6e' : '#e8ddd0',
                        stroke: '#f2ebe0',
                        strokeWidth: 0.6,
                        outline: 'none',
                        cursor: 'pointer',
                        filter: isHovered ? 'drop-shadow(0 0 6px rgba(193,123,110,0.5))' : 'none',
                      ...
                      pressed: { fill: '#8f4f44', outline: 'none' }
                    }}
                  />
                );
              })
      ...
      <div style={{ position: 'absolute', bottom: '1rem', left: '1rem', fontSize: '0.7rem', color: 'var(--ink-subtle)', fontStyle: 'italic' }}>
